...
public class TableauStat4 extends AbstractTableModel{
	...
	public TableauStat4(HashMap<String, Double> moyenneDepartementsNO2, HashMap<String, Double> moyenneDepartementsPM10, HashMap<String, Double> moyenneDepartementsPM25) {
